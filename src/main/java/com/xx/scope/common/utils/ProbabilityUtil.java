...
public class ProbabilityUtil {
    ...
    //几率最大值
    private final static int maxTate = 10000;

    /**
     * 查询是否中奖
     * @param prizeRate 中奖几率  10000
     * @return true-中奖 false-没中
     */
    public static boolean isWin(int prizeRate) {
        return RandomUtil.getRandomInt(maxTate) < prizeRate;
    }

    public static void main(String[] args) {
        System.err.println( isWin(5000));
   /*     ProbabilityUtil tr = new ProbabilityUtil();
        // 用List随机
